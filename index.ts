  ...
  do {
      ...
      if (account) {
        ...
        console.log(
          `Dear ${chalk.green.bold(name?.firstName)} ${chalk.green.bold(
            name?.lastName
          )} your account balance is ${chalk.blueBright.bold(
            `$${account.balance}`
          )}`
        );
      }
    ...
    if (ans.select === "Cash Withdraw") {
      ...
      if (account) {
        ...
        if (ans.rupees <= account.balance) {
          ...
          console.log(
            chalk.green.bold("Your Cash Withdraw is Successfully Completed")
          );
          console.log(
            chalk.green.bold(
              `Your remainning account balance is $${newBalance}`
            )
          );
        } else {
    ...
    if (ans.select === "Cash Deposit") {
      ...
      if (account) {
        ...
        console.log(
          chalk.green.bold("Your Cash Deposit is Successfully Completed")
        );
